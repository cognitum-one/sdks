...
__export(agentic_exports, {
  ALL_METRIC_INSTRUMENT_KINDS: () => ALL_METRIC_INSTRUMENT_KINDS,
  ATTR_CACHE_RESULT: () => ATTR_CACHE_RESULT,
  ATTR_CONTRACT_VERSION: () => ATTR_CONTRACT_VERSION,
  ATTR_ERROR_KIND: () => ATTR_ERROR_KIND,
  ATTR_MODEL_ALIAS: () => ATTR_MODEL_ALIAS,
  ATTR_OPERATION: () => ATTR_OPERATION,
  ATTR_OPERATION_STATE: () => ATTR_OPERATION_STATE,
  ATTR_PRODUCT: () => ATTR_PRODUCT,
  ATTR_PROTOCOL: () => ATTR_PROTOCOL,
  ATTR_REQUEST_ID: () => ATTR_REQUEST_ID,
  ATTR_RETRY_COUNT: () => ATTR_RETRY_COUNT,
  ATTR_ROUTING_PLANE: () => ATTR_ROUTING_PLANE,
  ATTR_ROUTING_REASON: () => ATTR_ROUTING_REASON,
  ATTR_TENANT_HASH: () => ATTR_TENANT_HASH,
  ATTR_TIER: () => ATTR_TIER,
  ...
  EVENT_ARTIFACT_VERIFIED: () => EVENT_ARTIFACT_VERIFIED,
  EVENT_BUDGET_COMMITTED: () => EVENT_BUDGET_COMMITTED,
  EVENT_BUDGET_RELEASED: () => EVENT_BUDGET_RELEASED,
  EVENT_BUDGET_RESERVED: () => EVENT_BUDGET_RESERVED,
  EVENT_CAPABILITIES_LOADED: () => EVENT_CAPABILITIES_LOADED,
  EVENT_CONSENT_REQUIRED: () => EVENT_CONSENT_REQUIRED,
  EVENT_EVIDENCE_VERIFIED: () => EVENT_EVIDENCE_VERIFIED,
  EVENT_OPERATION_STATE_CHANGED: () => EVENT_OPERATION_STATE_CHANGED,
  EVENT_OPERATION_WAIT_ENDED: () => EVENT_OPERATION_WAIT_ENDED,
  EVENT_PROCESS_ENDED: () => EVENT_PROCESS_ENDED,
  EVENT_PROCESS_STARTED: () => EVENT_PROCESS_STARTED,
  EVENT_REQUEST_END: () => EVENT_REQUEST_END,
  EVENT_REQUEST_RETRY_SCHEDULED: () => EVENT_REQUEST_RETRY_SCHEDULED,
  EVENT_REQUEST_START: () => EVENT_REQUEST_START,
  EVENT_STREAM_END: () => EVENT_STREAM_END,
  EVENT_STREAM_FIRST_EVENT: () => EVENT_STREAM_FIRST_EVENT,
  EVENT_TELEMETRY_DROPPED: () => EVENT_TELEMETRY_DROPPED,
  MAX_TRACESTATE_MEMBERS: () => MAX_TRACESTATE_MEMBERS,
  MEASUREMENT_KIND_BY_INSTRUMENT: () => MEASUREMENT_KIND_BY_INSTRUMENT,
  METRIC_CACHE_TOKEN_COUNT: () => METRIC_CACHE_TOKEN_COUNT,
  METRIC_CANCELLATION_COUNT: () => METRIC_CANCELLATION_COUNT,
  METRIC_COST_COMMITTED: () => METRIC_COST_COMMITTED,
  METRIC_COST_RECONCILED: () => METRIC_COST_RECONCILED,
  METRIC_COST_RELEASED: () => METRIC_COST_RELEASED,
  METRIC_COST_RESERVED: () => METRIC_COST_RESERVED,
  METRIC_ERROR_COUNT: () => METRIC_ERROR_COUNT,
  METRIC_FIRST_EVENT_LATENCY: () => METRIC_FIRST_EVENT_LATENCY,
  METRIC_INPUT_TOKEN_COUNT: () => METRIC_INPUT_TOKEN_COUNT,
  METRIC_OPERATION_STATE_TRANSITION_COUNT: () => METRIC_OPERATION_STATE_TRANSITION_COUNT,
  METRIC_OUTPUT_TOKEN_COUNT: () => METRIC_OUTPUT_TOKEN_COUNT,
  METRIC_PROCESS_EXIT_COUNT: () => METRIC_PROCESS_EXIT_COUNT,
  METRIC_PROCESS_FORCED_TERMINATION_COUNT: () => METRIC_PROCESS_FORCED_TERMINATION_COUNT,
  METRIC_REQUEST_COUNT: () => METRIC_REQUEST_COUNT,
  METRIC_REQUEST_DURATION: () => METRIC_REQUEST_DURATION,
  METRIC_RETRY_COUNT: () => METRIC_RETRY_COUNT,
  ...
  metaProxySpanName: () => metaProxySpanName,
  ...
  parseUpgradeAffordance: () => parseUpgradeAffordance,
  ...
  verifyExecutionReceipt: () => verifyExecutionReceipt,
...
var EVENT_REQUEST_START = "request.start";
var EVENT_REQUEST_RETRY_SCHEDULED = "request.retry_scheduled";
var EVENT_REQUEST_END = "request.end";
var EVENT_STREAM_FIRST_EVENT = "stream.first_event";
var EVENT_STREAM_END = "stream.end";
var EVENT_OPERATION_STATE_CHANGED = "operation.state_changed";
var EVENT_OPERATION_WAIT_ENDED = "operation.wait_ended";
var EVENT_CAPABILITIES_LOADED = "capabilities.loaded";
var EVENT_BUDGET_RESERVED = "budget.reserved";
var EVENT_BUDGET_COMMITTED = "budget.committed";
var EVENT_BUDGET_RELEASED = "budget.released";
var EVENT_CONSENT_REQUIRED = "consent.required";
var EVENT_PROCESS_STARTED = "process.started";
var EVENT_PROCESS_ENDED = "process.ended";
var EVENT_ARTIFACT_VERIFIED = "artifact.verified";
var EVENT_EVIDENCE_VERIFIED = "evidence.verified";
var EVENT_TELEMETRY_DROPPED = "telemetry.dropped";
...
var ALL_METRIC_INSTRUMENT_KINDS = [
...
function measurementKindOf(kind) {
...
function hmacSha256Hex(key, bytes) {
  return (0, import_node_crypto4.createHmac)("sha256", Buffer.from(key)).update(bytes, "utf8").digest("hex");
}
function constantTimeHexEqual(a, b) {
  const bufA = Buffer.from(a, "hex");
  const bufB = Buffer.from(b, "hex");
  if (bufA.length === 0 || bufA.length !== bufB.length) return false;
  return (0, import_node_crypto4.timingSafeEqual)(bufA, bufB);
}
