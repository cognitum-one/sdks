...
- **Status:** Proposed
- **Date:** 2026-07-18
- **Deciders:** Cognitum SDK Working Group, Meta Proxy owner, MetaHarness owner, Security, SRE, FinOps, Developer Experience
- **Scope:** Meta Proxy HTTP SDK integration (`sdks/node`, `sdks/python`, `sdks/rust`)
